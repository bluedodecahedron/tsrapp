...
public class CustomCapturerObserver implements CapturerObserver {
    ...
    private static final int MAX_FPS = 1000; //Limits FPS to some custom value since device video capturer is usually restricted to fixed values (often 15, 30, 45, 60)
